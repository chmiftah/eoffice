            ...
            <div class="card shadow">
                ...
                <div class="row p-4">
                  <div class="col-lg-5 col-sm-12">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('assign.create') }}" autocomplete="off">
                                @csrf
                                <div class="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="permissions[]"  class="form-control select2multiple yo" id="yo" multiple="multiple" >
                                    ...
                                    <table class="table align-items-center table-flush">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td><a href="{{ route('assign.edit' ,$role) }}" class="btn btn-info btn-sm">edit</a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
